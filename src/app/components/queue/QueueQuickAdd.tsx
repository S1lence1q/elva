...
export function QueueQuickAdd({
  ...
  return (
    <>
      ...
      {/* History section — CSS max-height accordion */}
      <div
        className="overflow-hidden transition-[max-height,opacity] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]"
        style={{
          maxHeight: showHistory && localHistory.length > 0 ? '280px' : '0px',
          opacity: showHistory && localHistory.length > 0 ? 1 : 0,
        }}
      >
