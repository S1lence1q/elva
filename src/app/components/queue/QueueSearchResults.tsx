            ...
            >
              {matchedArtist && (
                <motion.div
                  ...
                  className="group w-full flex flex-col gap-5 p-6 rounded-3xl bg-[#0d0e15]/90 border border-white/[0.08] hover:bg-[#13141c]/75 hover:border-white/15 transition-all duration-300 shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_12px_40px_rgba(0,0,0,0.5)] cursor-pointer relative overflow-hidden will-change-transform"
                >
