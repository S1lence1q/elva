...
export const ACCENT_THEMES: Record<AccentColor, ThemeColors> = {
  emerald: {
    ...
    welcomeFrom: 'from-emerald-950/15',
    welcomeVia: 'via-neutral-950/20',
    welcomeTo: 'to-neutral-950/30',
